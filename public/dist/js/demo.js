...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      alert('Selamat Datang di Website Sistem Managemen Surat Modern dengan E-SMS')
    }
  }, 1000)
  ...
  var mainHeaderElement = $('.main-header')[0]
  if (mainHeaderElement && mainHeaderElement.classList) {
    mainHeaderElement.classList.forEach(function (className) {
  ...
  var mainSidebarElement = $('.main-sidebar')[0]
  if (mainSidebarElement && mainSidebarElement.classList) {
    mainSidebarElement.classList.forEach(function (className) {
  ...
  var mainSidebarLightElement = $('.main-sidebar')[0]
  if (mainSidebarLightElement && mainSidebarLightElement.classList) {
    mainSidebarLightElement.classList.forEach(function (className) {
  ...
  var brandLinkElement = $('.brand-link')[0]
  if (brandLinkElement && brandLinkElement.classList) {
    brandLinkElement.classList.forEach(function (className) {
