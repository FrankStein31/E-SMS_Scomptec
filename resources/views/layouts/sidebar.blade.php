    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="">
                ...
                <span class="menu-title">Entri Surat</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="">
                ...
                <span class="menu-title">Draft Surat</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="">
                ...
                <span class="menu-title">Surat Terkirim</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#pengendalian" aria-expanded="false" aria-controls="pengendalian">
                <i class="mdi mdi-tune menu-icon"></i>
                <span class="menu-title">Pengendalian</span>
